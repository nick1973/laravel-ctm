                ...
                <div class="jumbotron">
                    <div class="container">
                        ...
                        <div class="col-md-6">
                            ...
                            <img src="/{{ access()->user()->name . access()->user()->lastname . access()->user()->dob }}/passport_photo/{{ access()->user()->photo }}" alt="{{ access()->user()->name }}" title="{{ access()->user()->name }}" height="100px" class="img-rounded">
                                @else
