                        ...
                        "data": function (data) {
                            if(data.rtw_docs == 1){
                                return  '<form method="POST">' +
                                        ...
                                        '<input onclick="return submitForm(this.form)" name="rtw_docs" type="checkbox" value="1" checked>' +
                                        '<input name="rtw_docs" type="checkbox" value="0" hidden checked>' +
                                ...
                                return  '<form method="POST">' +
                                        ...
                                        '<input name="id" type="text" value="'+data.id+'" hidden>' +
                                        '<input name="rtw_docs" type="checkbox" value="0" hidden checked>' +
                                        '<input onclick="return submitForm(this.form)" name="rtw_docs" type="checkbox" value="1">' +
                                        //'<input onclick="return submitForm(this.form)" type="button" value="Save" >' +
                                        '</form>'
                            }
                        }, className: "centre get"
