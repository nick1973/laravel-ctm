            ...
            <div class="col-lg-8">
                {{ Form::open(['route' => 'dashboard.ops.store', 'class' => 'form-horizontal', 'onKeyUp' => 'calc()']) }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10 col-md-6 col-lg-6">
                            <input type="text" class="form-control" id="contract_manager" placeholder="Contract Manager" name="contract_manager">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 col-md-3 col-lg-3 control-label">Operation Manager</label>
                        <div class="col-sm-10 col-md-6 col-lg-6">
                            <input type="text" class="form-control" id="operation_manager" placeholder="Operation Manager" name="operation_manager">
                        </div>
                    </div>
