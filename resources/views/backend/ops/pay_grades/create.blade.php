            ...
            {{ Form::open(['route' => 'admin.ops.pay_grade.store', 'class' => 'form-horizontal', 'onKeyUp' => 'calc()']) }}
                <div class="col-lg-4 col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5 col-lg-5 col-md-5">
                                <input type="text" class="form-control" id="pay" placeholder="Pay" name="pay">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-5 col-lg-5 col-md-6 control-label">Charge p/h</label>
                            <div class="col-sm-5 col-lg-5 col-md-5">
                                <input type="text" class="form-control" id="charge" placeholder="Charge p/h" name="charge_per_hour">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-5 col-lg-5 col-md-6 control-label">Margin p/h</label>
                            <div class="col-sm-5 col-lg-5 col-md-5">
                                <input type="text" class="form-control" id="margin" placeholder="Margin p/h" name="margin">
                            </div>
                        </div>
                </div>
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5 col-lg-5 col-md-5">
                            <input type="text" class="form-control" id="leeway" placeholder="Leeway" name="leeway">
                        </div>
                    </div>
                    <div class="form-group">
